...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*jelovnik*/ 2 && button0_id_value !== (button0_id_value = /*jelovnik*/ ctx[1] ? "button" : "button-deactivated")) {
    				attr_dev(button0, "id", button0_id_value);
    			}

    			if (dirty & /*jelovnik*/ 2 && button1_id_value !== (button1_id_value = !/*jelovnik*/ ctx[1] ? "button" : "button-deactivated")) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const toggleButton = page => {
    		if (page === "jelovnik") {
    			$$invalidate(1, jelovnik = true);
    			$$invalidate(0, src = "./images/jelovnik.svg");
    		} else if (page === "ponude") {
    			$$invalidate(1, jelovnik = false);
    			$$invalidate(0, src = "./images/ponude.svg");
    		}
    	};
    	...
    	const click_handler = () => toggleButton("jelovnik");
    	const click_handler_1 = () => toggleButton("ponude");
    	$$self.$capture_state = () => ({ src, jelovnik, isMobile, toggleButton });

    	$$self.$inject_state = $$props => {
    		if ("src" in $$props) $$invalidate(0, src = $$props.src);
    		if ("jelovnik" in $$props) $$invalidate(1, jelovnik = $$props.jelovnik);
    	...
    	return [src, jelovnik, isMobile, toggleButton, click_handler, click_handler_1];
    }
